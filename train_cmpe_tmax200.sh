#!/bin/bash
#SBATCH --job-name=dingo_train_cmpe_tmax200  # Optional: give your job a name
...
#SBATCH --output=training/cmpe_tmax200/logs/train.log  # Output log file
...
dingo_train --settings_file training/cmpe_tmax200/train_settings.yaml --train_dir training/cmpe_tmax200
