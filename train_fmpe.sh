#!/bin/bash
#SBATCH --job-name=dingo_train_fmpe  # Optional: give your job a name
...
#SBATCH --output=training/fmpe/logs/train.log  # Output log file
...
dingo_train --settings_file training/fmpe/train_settings.yaml --train_dir training/fmpe
