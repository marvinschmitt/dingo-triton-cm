#!/bin/bash
#SBATCH --job-name=cmpe_t50  # Optional: give your job a name
...
#SBATCH --output=training/cmpe_tmax50/logs/train.log  # Output log file
...
dingo_train --settings_file training/cmpe_tmax50/train_settings.yaml --train_dir training/cmpe_tmax50
