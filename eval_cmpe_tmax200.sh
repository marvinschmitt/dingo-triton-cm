#!/bin/bash
#SBATCH --job-name=eval_cmpe200  # Optional: give your job a name
...
#SBATCH --output=training/cmpe_tmax200/logs/eval.log  # Output log file
...
dingo_pipe training/cmpe_tmax200/GW150914.ini --disable-hdf5-locking=True
# python -m dingo.gw.pipe.sampling training/cmpe_tmax10/GW150914.ini

python eval_plot.py cmpe_tmax200
conda deactivate